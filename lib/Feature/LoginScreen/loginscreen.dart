...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void login()
  {
    ...
    _auth.signInWithEmailAndPassword(
      ...
      Utility().toastmessage('Invalid email or password');
      setState(() {
        loading=false;
      });
    });
           ...
           child: Form(
             ...
             child: Column(
              ...
              children: [
                ...
                makeInput(allcontroller: emailcontroller,Htext: 'Email Address',text: 'Enter Email',KeyboardType: TextInputType.emailAddress

                ),
              makeInput(obsureText: _isobscure,allcontroller: passwordcontroller,text: 'Enter Password',Htext: ' Password',
                  Iconss:  IconButton(
                    onPressed: (){
                      setState(() {
